...
class EditarClienteWidget extends StatefulWidget {
  ...
  static String routeName = 'editarCliente';
  static String routePath = '/editarCliente';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuariosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRow> editarClienteUsuariosRowList = snapshot.data!;

        final editarClienteUsuariosRow = editarClienteUsuariosRowList.isNotEmpty
            ? editarClienteUsuariosRowList.first
            : null;
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController1 ??=
                            ...
                            text: editarClienteUsuariosRow?.nome,
                          ),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController2 ??=
                              TextEditingController(
                            text: editarClienteUsuariosRow?.telefone,
                          ),
                          ...
                          Expanded(
                            child: Slider(
                              ...
                              value: _model.sliderValue ??=
                                ...
                                editarClienteUsuariosRow?.confianca,
                                0.0,
                              ),
                              onChanged: (newValue) {
                                newValue =
