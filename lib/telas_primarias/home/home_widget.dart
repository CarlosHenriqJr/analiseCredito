...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.pegarResultado = await UsersTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'email',
          currentUserEmail,
        ),
      );
      if (_model.pegarResultado?.length == 0) {
        context.pushNamed(
          FinalizarCadastroWidget.routeName,
                            ...
                            return Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      VerClientesWidget.routeName,
                                      queryParameters: {
                                        'recID': serializeParam(
                                          listViewUsuariosRow.id,
                                          ParamType.int,
                                        ),
                                      }.withoutNulls,
                                    );
